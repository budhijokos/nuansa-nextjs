    ...
    <>
      ...
      {relatedArticles.length > 0 && (
        <div className="mt-20 pt-12 border-t border-stone-200 dark:border-stone-850 related-articles">
          <h3 className="text-2xl font-bold text-stone-900 dark:text-white mb-8">Artikel Terkait</h3>
            ...
            {relatedArticles.map((rel) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col justify-center">
                  ...
                  <h4 className="text-base font-bold text-stone-900 dark:text-white group-hover:text-emerald-800 dark:group-hover:text-emerald-400 transition line-clamp-2">{rel.title}</h4>
      ...
      <footer className="mt-20 pt-12 border-t border-stone-200 dark:border-stone-850">
        <div className="bg-stone-100 dark:bg-[#151514] border border-transparent dark:border-stone-850 rounded-3xl p-8 md:p-12 text-center space-y-6">
          <h3 className="text-xl font-bold text-stone-900 dark:text-white">Siap Melangkah Lebih Jauh?</h3>
