    ...
    <header className={`sticky top-0 z-50 transition-all duration-300 ${
      ...
      <nav aria-label="Navigasi Utama" className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <div className="hidden lg:flex items-center space-x-8">
          ...
          <Link href="/artikel" className="text-sm font-medium text-stone-600 dark:text-stone-300 hover:text-emerald-800 dark:hover:text-emerald-400 transition duration-150">
            Artikel
          </Link>
